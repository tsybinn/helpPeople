...
if (isset($_SERVER['REQUEST_METHOD']) == "POST" and  isset($_POST['submitUpdate'])) {
    ...
    $db->update("news", $prevText, $detailText, $fotoUrl,$video, $id);
...
<div class="wraple">
    <form enctype="multipart/form-data" method="POST">
        <div class="form-group">
            ...
            <? endif ?>
            <textarea class="form-control" name="prevText"><?= $ITEMS["prevText"] ?></textarea>
        </div>
        <div class="form-group">
            <? if (!empty($error["prevText"])) : ?>
                <label class="error" for="exampleInputEmail1"><?= $error['prevText'] ?></label><br>
            ...
            <? endif ?>
            <textarea class="form-control" name="detailText" id="" rows="3"><?= $ITEMS['detailText'] ?></textarea>
        </div>
        ...
        <? for ($i = 0; $i <= 1; $i++) : ?>
            <? if (!empty($ITEMS["video$i"])) : ?>
                    ...
                    <div class="col">
                        <iframe width="350" height="300" src="https://www.youtube.com/embed/<?=$ITEMS["video$i"] ?>" frameborder="0"
