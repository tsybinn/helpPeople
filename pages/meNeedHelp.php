...
if((isset($_POST['phone'])&&$_POST['phone']!="")){ //Проверка отправилось ли наше поля name и не пустые ли они
    $to = 'Lenalaxina@yandex.ru'; //Почта получателя, через запятую можно указать сколько угодно адресов
    ...
    if(mail($to, $subject, $message, $headers)){
        echo "<h2>Ваше сообщение успешно отравлено !!!</h2>";
...
<div class="row helpmee">
 ...
 <button type="submit" name="simbitHelpMee" id="form-submit" class="btnbtn-success btn-lg pull-right ">Отправить</button>
</form>
